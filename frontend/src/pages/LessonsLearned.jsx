                    ...
                    <div className="flex items-center gap-2 max-w-3xl mx-auto">
                        ...
                        {mode === 'search' && (
                            <button
                                ...
                                className={`flex items-center gap-1.5 px-3 py-2.5 rounded-xl border text-xs font-medium whitespace-nowrap transition-all flex-shrink-0 ${
                                    exactMatch
                ...
                <div className="fixed inset-0 z-[100] flex items-center justify-center">
                    ...
                    <div className="relative bg-white rounded-xl shadow-2xl w-[520px] max-h-[70vh] flex flex-col overflow-hidden">
                        ...
                        <div className="flex-1 overflow-y-auto px-5 py-4">
                            ...
                            {isAdmin && (
                                <div className="mb-5">
                                    <div className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">DOC-Master 인덱싱 DB</div>
                                    <button
